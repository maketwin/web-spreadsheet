 ...
 */
export function shiftSheetChartAnchors(store: Store, kind: 'insert' | 'delete', axis: 'row' | 'col', start: number, count: number, sheetId?: string): void {
